class hallimaneFoodRunner
{
    public static void main(String[] args)
    {
        ...
        int price1 = hallimaneFood.getPriceByFoodItemType(name1, type1);
        ...
        int price2 = hallimaneFood.getPriceByFoodItemType(name2, type2);
        ...
        int price3 = hallimaneFood.getPriceByFoodItemType(name3, type3);
        ...
        int price4 = hallimaneFood.getPriceByFoodItemType(name4, type4);
        ...
        int price5 = hallimaneFood.getPriceByFoodItemType(name5, type5);
        ...
        int price6 = hallimaneFood.getPriceByFoodItemType(name6, type6);
        ...
        int juicePrice1 = hallimaneFood.getPriceByJuiceName(juiceName1);
        ...
        int juicePrice2 = hallimaneFood.getPriceByJuiceName(juiceName2);
        ...
        int juicePrice3 = hallimaneFood.getPriceByJuiceName(juiceName3);
        ...
        int juicePrice4 = hallimaneFood.getPriceByJuiceName(juiceName4);
        ...
        int juicePrice5 = hallimaneFood.getPriceByJuiceName(juiceName5);
        ...
        String sponsor1 = hallimaneFood.getSponsorNameByTotalBill(totalBill1);
        ...
        String sponsor2 = hallimaneFood.getSponsorNameByTotalBill(totalBill2);
        ...
        String sponsor3 = hallimaneFood.getSponsorNameByTotalBill(totalBill3);
        ...
        String sponsor4 = hallimaneFood.getSponsorNameByTotalBill(totalBill4);
        ...
        String sponsor5 = hallimaneFood.getSponsorNameByTotalBill(totalBill5);
